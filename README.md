...
[![Pipeline Status](https://plmlab.math.cnrs.fr/lothode/SuperFluids.jl/badges/master/pipeline.svg)](https://plmlab.math.cnrs.fr/lothode/SuperFluids.jl/-/pipelines)
[![Latest Release](https://plmlab.math.cnrs.fr/lothode/SuperFluids.jl/-/badges/release.svg)](https://plmlab.math.cnrs.fr/lothode/SuperFluids.jl/-/releases)
[![Documentation](https://img.shields.io/badge/documentation-online-blue.svg)](https://lothode.pages.math.cnrs.fr/SuperFluids.jl)
...
```
git clone git@plmlab.math.cnrs.fr:lothode/SuperFluids.jl.git
```
